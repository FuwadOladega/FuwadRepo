...
<section id="header">
     ...
     <h2> Order Receipt</h2>
     <?php echo "<div id='order-container'><p><strong>Order Number: </strong>#".$_SESSION['orderNum']."</p></div>";?>
     ...
     echo "<td><span class='header-price'>$".$_SESSION['beforeTax']."</span></td>"; 
     echo "</tr>";

     echo "<tr>";
     echo "<td><h3 class='header-table'>Price After taxes</h3></td>";
     echo "<td><span class='header-price'>$".$_SESSION['AfterTax']."</span> </td>"; 
     echo "</tr>";

     echo "<tr style='margin:10px 0px; height:100px;'> ";
     echo "<td colspan='2'><a href='order.php'><button id='btn10'>Place Order</button></a></td>";
     echo "</tr>";
     echo "</table>";
